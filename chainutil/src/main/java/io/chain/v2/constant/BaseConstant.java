...
public class BaseConstant {
    ...
    public static final String MAINNET_DEFAULT_ADDRESS_PREFIX =ProperitesRead.getProperties("prefix");
    public static final String TESTNET_DEFAULT_ADDRESS_PREFIX = "t".concat(ProperitesRead.getProperties("prefix"));
    /**
     * hash length
     */
